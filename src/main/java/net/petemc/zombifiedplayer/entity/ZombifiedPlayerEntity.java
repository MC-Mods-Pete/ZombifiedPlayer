...
public class ZombifiedPlayerEntity extends Zombie {
    ...
    public void dropInventory(ServerLevel serverLevel) {
        ...
        for (ItemStack trinketsItem : this.trinketsItems) {
            if (!trinketsItem.isEmpty()) {
                this.spawnAtLocation(serverLevel, trinketsItem);
            }
        }
    ...
    public static ZombifiedPlayerEntity spawnZombifiedPlayer(Player player) {
        ...
        if (player.level() instanceof ServerLevel serverLevel) {
            zombifiedPlayer = new ZombifiedPlayerEntity(ModEntities.ZOMBIFIED_PLAYER, serverLevel);
    ...
    public void transferInventory(ServerLevel serverLevel, Player playerEntity) {
        ...
        // Currently Accessories is not available for Minecraft 26.1.x
        /*
    ...
    public void addAdditionalSaveData(@NotNull ValueOutput valueOutput) {
        ...
        // Store Trinket items
        TrinketsUtil.saveTrinketItems(valueOutput.list("TrinketsItems", ItemStackWithSlot.CODEC), this.trinketsItems);
    ...
    public void readAdditionalSaveData(@NotNull ValueInput valueInput) {
        ...
        // Load Trinket items
        TrinketsUtil.loadTrinketItems(valueInput.listOrEmpty("TrinketsItems", ItemStackWithSlot.CODEC), this.trinketsItems);
        // Load Accessories items
        //AccessoiresUtil.loadAccessoiresItems(valueInput.listOrEmpty("AccessoiresItems", ItemStackWithSlot.CODEC), this.accessoriesItems);
    }
